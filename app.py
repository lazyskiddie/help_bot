...
st.markdown(
    """
    <style>
    /* Center the main title (h1 tag generated by st.title) */
    .stApp h1 {
        text-align: center;
        width: 100%; /* Ensure it takes full width for centering to work effectively */
    }

    /* Adjust padding for the main content area if needed.
    ...
    /* Style for the chat messages - optional, but makes it look cleaner */
    /* These classes are applied by st.chat_message */
